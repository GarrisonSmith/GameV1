...
namespace Fantasy.Engine.Drawing.Animating
{
	...
	/// </summary>
	public class CustomizableAnimation : Animation<ILocatable>
	{
		...
		public void Update(GameTime gameTime)
		{
			...
			if (currentFrameDuration.TotalMilliseconds >= frames[activeFrameIndex].MinDurationMili && CurrentFrameDuration >= CurrentFrameMaxDuration)
			{
				currentFrameDuration = TimeSpan.Zero;
				activeFrameIndex++;
				...
				currentFrameMaxDuration = new TimeSpan(0, 0, 0, 0, Random.Next(frames[activeFrameIndex].MaxDurationExtension));
			}
		}
		/// <summary>
