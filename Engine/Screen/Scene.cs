    ...
    public class Scene
    {
        ...
        public Scene()
        {
            ...
            _entitySet.AddEntity(new Character("character", "character", Global._content.Load<Texture2D>(@"character-sets\character_three_spritesheet"), 1, new Point(64, 128),
                new Entitybox(new Point(-408, 700), new Rectangle[] { new Rectangle(16, -104, 32, 24) }), new MoveSpeed(96, TimeUnits.seconds), Orientation.down), true);
        ...
        public void LoadScene()
        {
            ...
            light = new LightSource(1, new Point(-400, 500), new int[] { 300 }, new float[] { .5f }, new Color[] { Color.White });
        }
