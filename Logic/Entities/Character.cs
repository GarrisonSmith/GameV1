...
namespace Fantasy.Content.Logic.Entities
{
    class Character
    {
        ...
        public void DrawCharacter(Vector2 stretch, SpriteBatch _spriteBatch, int layer)
        {
            ...
            {
                frames.FinishAnimation(spritesheet, stretch, _spriteBatch, layer, new Vector2(position.X, position.Y));
            }
            else
            {
                frames.DrawNextFrame(spritesheet, stretch, _spriteBatch, layer, new Vector2(position.X, position.Y));
            }
        }
